...
#### Robots.txt
A robots.txt file was created to tell search engines where not to go on the site.
...
- Below the social media icons is a link to the sites private policy, which when clicked will bring the user to another page where they can read the Private Policy.
...
![footer](readme-docs/images/footer1.jpg)
- - -
...
- The image on the left is an image that I created using free trial of illustrator that says **Treat Yourself** and then underneather the text there is a button that says **Shop Now**, which once clicked will bring users to the all products page.
...
- Below this are the Product cards which are displayed in the bootstrap card format, they are displayed 4 across on x-large screens, 3 across on large screens, 2 on small and medium and 1 accross on x-small screens which makes the page fully resonsive to all devices.
...
- Then there is the form where the user will have to fill out the form with their **name**, **email**, **phone** and **address details**. There is also a check button that will save the info you have entered to your profile.
...
- Beside the **Complete Order** button there is a **Back** button which will bring the user back to their cart, underneath the buttons in red writing you will see text saying how much your card will be charged.
...
![Blog page](readme-docs/images/blog1.png) 

### Post Detail page
- At the top of the Post details you will have the Post title displayed using a h2 heading tag, directly below this will be the image of the blog post and then below that will be the Post body which will display the main text of a post. Everything is centered bar on small and extra small devices where they take up nearly the full width of the screen.
- Below the Post body there is a comment section that will show any comments posted by users(users need to be signed in to view the blog post and to also comment)
...
### Reviews Page
- At the top of the review page in the center is H1 heading that says **Customer Reviews**.
- If the users is signed in then there is a green **Add A Review** button to the left just above the most recent review.
- Then below this are the reviews, which are each in a light grey coloured box, at the top left of the box is the review title then opposite this at the right hand side is the review stars which can be from 1 - 5.
...
- Then there is the form below it with the field of **Title**, **Body**, and the **Rating** which is a drop down with choices from 1 - 5.
...
### Edit Review Page
- This is exactly like the **Add Review** page only the H2 heading at the top says **Edit Your Review** and has the form already prepoulated with the users previous review so that they can edit it.

![Edit Review Page](readme-docs/images/edit-review.png) 
- - -

### Add Product Page
- This page is only available to admins so that they can add a product to the site, on the top of the page is a H2 heading that is centered and says **Add a Product** with a horizontal line above and below it.
- Below this we have the form with the first input **category** being a drop down, there is the other inputs **Sku**, **Name**, **Type**, **Description**, **Price**, **Image Url** and **Image**.
...
- I would to thank tutor support for all the help when I got stuck and  could not figure an issue out, they provided great support.
